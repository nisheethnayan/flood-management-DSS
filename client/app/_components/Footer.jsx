...
const Footer = () => {
  const footerElements = ["About Us", "Sitemap", "Terms of Use", "Contact Us"];
  const footerIcons = [
  ...
  return (
    <div
      className="w-full h-full px-4 text-white bg-cover border-t-8 border-green-800 bg-center rounded-t-2xl"
      style={{
      ...
      <footer class="relative w-full">
        <div class="w-full px-2 md:px-8 mx-auto max-w-7xl">
          <div class="grid justify-between grid-cols-2">
            ...
            <div class="flex justify-end grid-cols-1 gap-2 p-5">
              <ul>
                {footerElements.map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      class="block py-2 font-sans text-base font-bold leading-relaxed text-gray-500 antialiased transition-colors hover:text-white"
                    >
                      {item}
                    </a>
                  </li>
